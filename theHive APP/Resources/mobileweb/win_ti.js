...
channelTable.addEventListener("click:channel", function(evt) {
    ...
    chat.on("joined", function(messages) {
        ...
        setTimeout(function() {
            chatTable.scrollToIndex(rows.length - 1, {
                animated: false
            });
    ...
    var addMessage = function(message) {
        ...
        chatTable.appendRow(row, {
            animated: true
        });
        setTimeout(function() {
            chatTable.scrollToIndex(lastRowIndex, {
                animated: true
            });
            lastRowIndex += 1;
        }, 100);
