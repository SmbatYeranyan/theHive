(function(module, io) {
    module.exports = {
        "parse uri": function() {
            var http = io.util.parseUri("http://google.com"), https = io.util.parseUri("https://www.google.com:80"), query = io.util.parseUri("google.com:8080/foo/bar?foo=bar");
        ...
        "unique uri": function() {
            var protocol = io.util.parseUri("http://google.com"), noprotocol = io.util.parseUri("google.com"), https = io.util.parseUri("https://google.com"), path = io.util.parseUri("https://google.com/google.com/com/?foo=bar");
        ...
        "merge query strings": function() {
            var base = io.util.query("foo=bar", "foo=baz"), add = io.util.query("foo=bar", "bar=foo");
