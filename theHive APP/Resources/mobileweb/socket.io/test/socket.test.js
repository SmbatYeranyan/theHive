(function(module) {
    if ("object" == typeof global) return module.exports = {
        "": function() {}
    };
    module.exports = {
        ...
        "test receiving messages": function(next) {
            var socket = create(), connected = false, messages = 0;
            socket.on("error", function(msg) {
                throw new Error(msg || "Received an error");
            });
            socket.on("connect", function() {
        ...
        "test connecting to namespaces": function(next) {
            ...
            var io = create(), socket = io.socket, namespaces = 2, connect = 0;
            socket.on("connect", function() {
                connect++;
            });
        ...
        "test disconnecting from namespaces": function(next) {
            ...
            var socket = create().socket, namespaces = 2;
        ...
        "test authorizing for namespaces": function(next) {
            ...
            socket.of("/a").on("connect_failed", function() {
                next();
            }).on("error", function(msg) {
                throw new Error(msg || "Received an error");
            });
...
})("undefined" == typeof module ? module = {} : module, "undefined" == typeof io ? require("socket.io-client") : io, "undefined" == typeof should ? require("should-browser") : should);