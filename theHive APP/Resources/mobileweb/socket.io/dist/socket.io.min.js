(function(a, b) {
    var c = a;
    c.version = "0.9.1-1", c.protocol = 1, c.transports = [], c.j = [], c.sockets = {}, 
    c.connect = function(a, d) {
        ...
        c.util.merge(h, d);
        (h["force new connection"] || !c.sockets[f]) && (g = new c.Socket(h));
        return !h["force new connection"] && g && (c.sockets[f] = g), g = g || c.sockets[f], 
    ...
    c.parseUri = function(a) {
        ...
        var f, b = {}, c = a.split("&"), d = 0, e = c.length;
        for (;e > d; ++d) f = c[d].split("="), f[0] && (b[f[0]] = f[1]);
        return b;
    };
    var f = !1;
    c.load = function(a) {
        if ("document" in b && "complete" === document.readyState || f) return a();
        c.on(b, "load", a, !1);
        ...
        for (i in d) d.hasOwnProperty(i) && 0 > c.indexOf(g, i) && ("object" == typeof b[i] && h ? c.merge(b[i], d[i], h - 1, g) : (b[i] = d[i], 
        g.push(d[i])));
        return b;
        ...
        for (var g = 0, h = f.length; h > g; g++) ~c.indexOf(e, f[g]) && d.push(f[g]);
        return d;
    ...
    a.EventEmitter = c, c.prototype.on = function(a, c) {
        ...
        if (this.$events && this.$events[a]) {
            ...
            if (b.util.isArray(d)) {
                var e = -1;
                for (var f = 0, g = d.length; g > f; f++) if (d[f] === c || d[f].listener && d[f].listener === c) {
                    e = f;
                    break;
                }
                if (0 > e) return this;
        ...
        if ("function" == typeof c) c.apply(this, d); else {
            ...
            var e = c.slice();
            for (var f = 0, g = e.length; g > f; f++) e[f].apply(this, d);
        }
        return !0;
    };
...
function(exports, nativeJSON) {
    ...
    function str(a, b) {
        ...
        i instanceof Date && (i = date(a)), "function" == typeof rep && (i = rep.call(b, a, i));
        switch (typeof i) {
          case "string":
            return quote(i);
          ...
          case "object":
            ...
            if (rep && "object" == typeof rep) {
                f = rep.length;
                for (c = 0; f > c; c += 1) "string" == typeof rep[c] && (d = rep[c], e = str(d, i), 
    ...
    JSON.stringify = function(a, b, c) {
        var d;
        gap = "", indent = "";
        if ("number" == typeof c) for (d = 0; c > d; d += 1) indent += " "; else "string" == typeof c && (indent = c);
        rep = b;
...
function(a, b) {
    ...
    c.decodePacket = function(a) {
        ...
        if ("�" == a.charAt(0)) {
            var b = [];
            for (var d = 1, e = ""; a.length > d; d++) "�" == a.charAt(d) ? (b.push(c.decodePacket(a.substr(d + 1).substr(0, e))), 
...
function(a, b) {
    ...
    a.Transport = c, b.util.mixin(c, b.EventEmitter), c.prototype.onData = function(a) {
        ...
        return this.close && this.open && this.close(), this.clearTimeouts(), this.socket.onDisconnect(), 
        this;
    ...
    a.Socket = d, b.util.mixin(d, b.EventEmitter), d.prototype.of = function(a) {
        ...
        if (this.isXDomain() && !b.util.ua.hasCORS) {
            ...
            j.open("GET", g, !0), j.withCredentials = !0, j.onreadystatechange = function() {
                4 == j.readyState && (j.onreadystatechange = e, 200 == j.status ? f(j.responseText) : !c.reconnecting && c.onError(j.responseText));
            }, j.send(null);
        }
    }, d.prototype.getTransport = function(a) {
        var c = a || this.transports;
        for (var f, e = 0; f = c[e]; e++) if (b.Transport[f] && b.Transport[f].check(this) && (!this.isXDomain() || b.Transport[f].xdomainCheck())) return new b.Transport[f](this, this.sessionid);
        return null;
        ...
        return this.handshake(function(d, e, f, g) {
            ...
            c.sessionid = d, c.closeTimeout = 1e3 * f, c.heartbeatTimeout = 1e3 * e, c.transports = b.util.intersect(g.split(","), c.options.transports), 
            c.setHeartbeatTimeout(), h(), c.once("connect", function() {
        ...
        this.doBuffer = a, !a && this.connected && this.buffer.length && (this.transport.payload(this.buffer), 
        this.buffer = []);
    }, d.prototype.disconnect = function() {
        (this.connected || this.connecting) && (this.open && this.of("").packet({
            type: "disconnect"
        ...
        (b || c) && (this.transport.close(), this.transport.clearTimeouts(), b && (this.publish("disconnect", a), 
        ...
        function f() {
            ...
            e()) : (a.on("connect_failed", f), a.options["try multiple transports"] = !0, a.transport = a.getTransport(), 
            a.redoTransports = !0, a.connect()) : (d > a.reconnectionDelay && (a.reconnectionDelay *= 2), 
...
if ("undefined" != typeof window) var swfobject = function() {
    ...
    function F() {
        ...
        if (b > 0) for (var c = 0; b > c; c++) {
            ...
            if (y.pv[0] > 0) {
                var g = P(d);
                if (g) if (!S(m[c].swfVersion) || y.wk && 312 > y.wk) if (m[c].expressInstall && H()) {
                    var h = {};
                    ...
                    for (var l = 0; k > l; l++) "movie" != j[l].getAttribute("name").toLowerCase() && (i[j[l].getAttribute("name")] = j[l].getAttribute("value"));
                    I(h, i, d, e);
    ...
    function H() {
        return !u && S("6.0.65") && (y.win || y.mac) && !(y.wk && 312 > y.wk);
    }
    function I(b, c, d, e) {
        u = !0, r = e || null, s = {
            success: !1,
        ...
        var g = P(d);
        if (g) {
            "OBJECT" == g.nodeName ? (p = K(g), q = null) : (p = g, q = d), b.id = f;
            (typeof b.width == a || !/%$/.test(b.width) && 310 > parseInt(b.width, 10)) && (b.width = "310");
            (typeof b.height == a || !/%$/.test(b.height) && 137 > parseInt(b.height, 10)) && (b.height = "137");
    ...
    function K(a) {
        ...
        if (y.win && y.ie) c.innerHTML = a.innerHTML; else {
            ...
            if (d) {
                ...
                if (e) {
                    var f = e.length;
                    for (var g = 0; f > g; g++) (1 != e[g].nodeType || "PARAM" != e[g].nodeName) && 8 != e[g].nodeType && c.appendChild(e[g].cloneNode(!0));
                }
            }
        }
        return c;
    ...
    (function() {
        ...
        y.ie && y.win && window.attachEvent("onunload", function() {
            var a = o.length;
            for (var b = 0; a > b; b++) o[b][0].detachEvent(o[b][1], o[b][2]);
            var c = n.length;
            for (var d = 0; c > d; d++) N(n[d]);
    ...
    return {
        ...
        embedSWF: function(c, d, e, f, g, h, i, j, k, l) {
            ...
            y.w3 && !(y.wk && 312 > y.wk) && c && d && e && f && g ? (U(d, !1), B(function() {
                e += "", f += "";
                var n = {};
        ...
        getQueryParamValue: function(a) {
            ...
            if (b) {
                ...
                var c = b.split("&");
                for (var d = 0; c.length > d; d++) if (c[d].substring(0, c[d].indexOf("=")) == a) return V(c[d].substring(c[d].indexOf("=") + 1));
            }
            return "";
        },
...
(function() {
    ...
    WebSocket = function(a, b, c, d, e) {
        ...
        for (var c = 0; b.length > c; ++c) b[c](a);
    ...
    WebSocket.loadFlashPolicyFile = function(a) {
        ...
        setTimeout(function() {
            ...
            for (var a = 0; WebSocket.__tasks.length > a; ++a) WebSocket.__tasks[a]();
            WebSocket.__tasks = [];
        }, 0);
        ...
        return setTimeout(function() {
            try {
                ...
                for (var c = 0; b.length > c; ++c) WebSocket.__instances[b[c].webSocketId].__handleEvent(b[c]);
            } catch (d) {
                a.error(d);
            }
        }, 0), !0;
    ...
    a.XHR = d, b.util.inherit(d, b.Transport), d.prototype.open = function() {
        ...
        var c = [];
        for (var d = 0, e = a.length; e > d; d++) c.push(b.parser.encodePacket(a[d]));
...
function(a, b, c) {
    ...
    d.prototype.name = "xhr-polling", d.prototype.open = function() {
        var a = this;
...
function(a, b, c) {
    ...
    e.prototype.post = function(a) {
        ...
        if (!this.form) {
            ...
            e.className = "socketio", e.style.position = "absolute", e.style.top = "-1000px", 
            e.style.left = "-1000px", e.target = g, e.method = "POST", e.setAttribute("accept-charset", "utf-8"), 
