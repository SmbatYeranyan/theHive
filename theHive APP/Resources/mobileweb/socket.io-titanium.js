var platform = {
    isAndroid: /android/i.test("mobileweb"),
    isIPhone: /iphone|ipad/i.test("mobileweb"),
    os: function(obj) {
        if (platform.isIPhone) return obj.iphone();
        if (platform.isAndroid) return obj.android();
...
platform.os({
    ...
    android: function() {
        Titanium.include("socket.io/lib/util.js", "socket.io/lib/json.js", "socket.io/lib/parser.js", "socket.io/lib/events.js", "socket.io/lib/namespace.js", "socket.io/lib/transport.js", "socket.io/lib/transports/xhr.js", "socket.io/lib/transports/websocket.js", "socket.io/lib/transports/xhr-polling.js", "socket.io/lib/socket.js");
    }
});
